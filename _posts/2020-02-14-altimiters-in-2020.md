...
- **Multi-sensor**: lots of altimeters only have barometric sensors. This works great while measuring the _descent_ of a rocket, but it is not well-suited for measuring and recording the _ascent_ of a rocket[^3]. I want a sensitive accelerometer gathering data at a high polling rate.
